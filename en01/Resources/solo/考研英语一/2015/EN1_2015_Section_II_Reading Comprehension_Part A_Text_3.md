...
31. It can be learned from Paragraph 1 that[A] Science intends to simplify its peer-review process.[B] journals are strengthening their statistical checks.[C] few journals are blamed for mistakes in data analysis.[D] lack of data analysis is common in research projects.
